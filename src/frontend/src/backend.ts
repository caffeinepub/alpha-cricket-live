...
export class Backend implements backendInterface {
    ...
    async getAllRegistrationsByTournament(): Promise<Array<Registration>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRegistrationsByTournament();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyRegistration(): Promise<Registration> {
        if (this.processError) {
            try {
